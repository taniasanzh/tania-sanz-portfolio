    ...
    return (
        <section id="stack" className="relative w-full flex flex-col items-center px-8 pt-12 pb-24 2xl:pt-16">
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col">
                ...
                <h2 className="flex justify-center 2xl:justify-start items-baseline text-4xl md:text-5xl tracking-tight leading-none mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0">
                    ...
                    <div className="flex flex-col md:pr-12">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">Frontend</h3>
                    ...
                    <div className="flex flex-col md:px-12 md:border-l border-dashed border-gray-300">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">Backend & DB</h3>
                        <ul className="flex flex-col gap-4">
                            <li className="flex items-center gap-3 text-gray-700 hover:text-gray-900 transition-colors cursor-default">
                                <span className="w-6 h-6 flex justify-center items-center bg-bg-inverse rounded-md">
                    ...
                    <div className="flex flex-col md:pl-12 md:border-l border-dashed border-gray-300">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">UX/UI & Tools</h3>
                        <ul className="flex flex-col gap-4">
                            <li className="flex items-center gap-3 text-gray-700 hover:text-gray-900 transition-colors cursor-default">
                                <span className="w-6 h-6 flex justify-center items-center bg-bg-inverse rounded-md">
